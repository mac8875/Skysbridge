...
exports.handler = async (event) => {
  ...
  try{
    ...
    if(requestType==='membership'){
      ...
      subject=`Your memorial for ${data.child_name} has been reviewed`; message=decision==='approve'?`The memorial for ${data.child_name} has been approved. If public display was requested, it can now appear in A Sky Full of Stars.`:`The memorial for ${data.child_name} was not approved at this time. ${reason||''}`;
